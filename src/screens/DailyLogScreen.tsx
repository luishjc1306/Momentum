    ...
    <div className="space-y-4">
      ...
      <Card>
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <Field label="Weight" type="number" step="0.1" value={log.weight} onChange={(event) => update('weight', numberValue(event.target.value))} />
          <Field label="Calories" type="number" value={log.calories} onChange={(event) => update('calories', numberValue(event.target.value))} />
          <Field label="Protein (g)" type="number" value={log.protein} onChange={(event) => update('protein', numberValue(event.target.value))} />
          <Field label="Carbs (g)" type="number" value={log.carbs} onChange={(event) => update('carbs', numberValue(event.target.value))} />
          <Field label="Fat (g)" type="number" value={log.fat} onChange={(event) => update('fat', numberValue(event.target.value))} />
          <Field label="Fiber (g)" type="number" value={log.fiber} onChange={(event) => update('fiber', numberValue(event.target.value))} />
          <Field label="Water (oz)" type="number" value={log.waterOz} onChange={(event) => update('waterOz', numberValue(event.target.value))} />
        </div>
      </Card>
      ...
      <Card>
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <Field label="Workout duration (min)" type="number" value={log.workoutDurationMinutes} onChange={(event) => update('workoutDurationMinutes', numberValue(event.target.value))} />
          <Field label="Cardio/walking distance (mi)" type="number" step="0.1" value={log.cardioDistanceMiles} onChange={(event) => update('cardioDistanceMiles', numberValue(event.target.value))} />
          <Field label="Steps" type="number" value={log.steps} onChange={(event) => update('steps', numberValue(event.target.value))} />
          <Field label="Sleep hours" type="number" step="0.1" value={log.sleepHours} onChange={(event) => update('sleepHours', numberValue(event.target.value))} />
      ...
      <Card>
        <div className="mb-3 flex items-center justify-between gap-3">
          <div>
            ...
            <h2 className="text-xl font-black">Common meals today</h2>
          </div>
        ...
        <div className="mb-4 grid gap-3 sm:grid-cols-2">
          ...
          <Field label="Meal calories" type="number" value={meal.calories} onChange={(event) => updateMeal('calories', numberValue(event.target.value))} />
          <Field label="Meal protein (g)" type="number" value={meal.protein} onChange={(event) => updateMeal('protein', numberValue(event.target.value))} />
          <Field label="Meal carbs (g)" type="number" value={meal.carbs} onChange={(event) => updateMeal('carbs', numberValue(event.target.value))} />
          <Field label="Meal fat (g)" type="number" value={meal.fat} onChange={(event) => updateMeal('fat', numberValue(event.target.value))} />
          <Field label="Meal fiber (g)" type="number" value={meal.fiber} onChange={(event) => updateMeal('fiber', numberValue(event.target.value))} />
